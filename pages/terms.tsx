    ...
    <div>
      ...
      <div className="herocont">
        <div className="inner" style={{ textAlign: "left", width: "700px" }}>
          ...
          <h3 className="text-2xl mb-4 font-bold mt-4">2. Use License</h3>
          ...
          <h3 className="text-2xl mb-4 font-bold mt-4">
          ...
          <h3 className="text-2xl mb-4 font-bold mt-4">8. Governing Law</h3>
          <p className="pb-20">
